...
class Database:
    ...
    def fetchQuery(self, query: str) -> list:
        ...
        for data in fetchQuery.fetchall():            
            listCustomers.append({
                ...
                "Name": data[1],
                "Age": data[2],
                # With data in position 3,4 and 5 use strip to delete white spaces
                "Email": data[3].strip(" "),
                "Adress": data[4].strip(" "),
    ...
    def fetchUserByName(self) -> list:
        ...
        customerList = []
        # Go throw the table data with for loop to store information 
        # in a list of dictionary to be return
        for cust in data:
            customerList.append({
                "Name": cust[0],
                "Age": cust[1]
    ...
    def saveData(self, customer: Customer) -> dict:
        ...
        """
        try:
            # Create session and add customer object

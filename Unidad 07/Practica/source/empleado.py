...
class Empleados:
    ...
    def __init__(self, nombre: str, apellido: str,
                 fecha_nacimiento: str, nro_dni: str):
        self.nombre = nombre
    ...
    def obtener_edad(self) -> str:
        ...
        return relativedelta(datetime.now(),
                             datetime.strptime(self.fecha_nacimiento,
                                               '%d/%m/%Y')).years
    ...
    def presentarse(self) -> str:
        ...
        return f'''Hola, soy {self.nombre} {self.apellido}.
                   Nací el {self.fecha_nacimiento}
                   y mi DNI es {self.nro_dni}'''
...
if __name__ == "__main__":
    ...
    empleado = Empleados("Alejandro", "Gomez", "20/11/1990", "35627087")
